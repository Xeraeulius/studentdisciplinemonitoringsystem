      ...
      <div class="box box-solid">
        <div class="box-body no-padding">
          <ul class="nav nav-pills nav-stacked">
            <li><a href="minor_offense_list_root.php"> Minor Offense</a></li>
            <li class="active"><a href="major_offense_list_root.php"> Major Offense</a></li>
          </ul>
        </div><!-- /.box-body -->
      </div><!-- /. box -->
    </div><!-- /.col -->
        ...
        <div class="box-body no-padding">
          <div class="table-responsive mailbox-messages">
            <table class="table table-hover table-striped">
              ...
              <tbody>
                <?php student_has_major_offense_root(); ?>
              </tbody>
            </table><!-- /.table -->
