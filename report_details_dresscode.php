							...
							<tr>
								...
								<form action="report_details.php" method="POST">
									<td>
										<div class="radio">
										<?php if ($row->status) { ?>
										  <label><input type="radio" name="optradio" value="<?php echo $row->status ?>" checked>Pending</label>
										<?php
										  }
										?>
										</div>
										<div class="radio">
										  <label><input type="radio" name="optradio" value="Violated">Issue Dress Code Violation</label>
										</div>
										<div class="radio">
